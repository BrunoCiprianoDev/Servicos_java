...
public class TesteItemDoisParteCinco {
	public static void main(String...args) {
		...
		/* Método listarContratosDeServico() com parametro NULL ordena os contratos de serviço conforme
		 * o padrão que foi estabelecido na sobreescrita "compareTo();" da classe Contrato.
		 */
		ArrayList<Contrato> listaContratosDeServicosPrestados = historico.listarContratosDeServico(null);	
