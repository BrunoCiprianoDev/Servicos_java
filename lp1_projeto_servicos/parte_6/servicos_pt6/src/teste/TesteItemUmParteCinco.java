...
public class TesteItemUmParteCinco {
	public static void main(String...args) {
		/**
		 * @author Bruno Cipriano
		 * O objetivo desse Teste é verificar os mecanismos de tratamento de erros quanto aos valores
		 * máximos permitidos para os atributos horasPrevistas e horasTrabalhadas no servico de um 
		 * contrato.
		 * 
		 */
		...
		Servico servicoQuatro = novoServico("Limpeza piscina grande", 70, 2401, 30);
		Servico servicoCinco = novoServico("Limpeza piscina pequena", 70, 39, 2434);
