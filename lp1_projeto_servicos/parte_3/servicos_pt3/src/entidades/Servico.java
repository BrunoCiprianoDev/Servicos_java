...
public class Servico {
	...
	public Servico(Servico servico) {
		this.codigoServico = servico.getCodigoServico();
		this.descricao = servico.getDescricao();
		this.valorHora = servico.getValorHora();
		this.horasPrevistas = servico.getHorasPrevistas();
		this.horasTrabalhadas = servico.getHorasTrabalhadas();
	}
